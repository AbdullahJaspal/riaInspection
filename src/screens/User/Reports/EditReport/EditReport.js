    ...
    return (
      <View style={[styles.itemContainer, {zIndex: 4000}]}>
        <View style={styles.headingContainer}>
          <Text style={styles.headingText}>Edit Report</Text>
        </View>
        <View style={styles.imgsRow}>
          <View>
            ...
            <Text style={styles.txtStyle}>
              Add Vin images{'\n'}or{'\n'}
              <Text style={styles.txtBoldStyle}>Capture</Text>
            </Text>
          </View>
          <View>
            <Image
        ...
        <View style={[styles.pickerRow1, {zIndex: 95}]}>
          <DropDown
            label={'Vehicle Type'}
            zIndex={95}
            data={[]}
    ...
    return (
      <View style={[styles.itemContainer, {zIndex: 3000}]}>
        ...
        <View style={[styles.pickerRow1, {zIndex: 87}]}>
          <DropDown label={'Full Car'} zIndex={87} data={[]} width={'44%'} />
        </View>
  ...
  const RenderFour = () => {
    return (
      <View style={[styles.itemContainer, {zIndex: 60}]}>
        ...
        <View style={[styles.pickerRow1, {zIndex: 49}]}>
          <DropDown label={'Full Car'} zIndex={49} data={[]} width={'45%'} />
        </View>
